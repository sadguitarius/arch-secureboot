...
# source=("$_pkgname::git+https://github.com/sadguitarius/arch-secureboot#branch=fix-duplicate-signatures")
source=("$_pkgname::/home/sadguitarius/dev/source/arch-secureboot/")
sha256sums=("SKIP")
install=".install"
